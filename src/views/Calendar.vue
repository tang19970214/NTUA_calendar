...
export default {
  ...
  methods: {
    ...
    async getUnitListItemFun() {
      await this.$api.GetUnitListItem().then((res) => {
        // this.getUnitListItemData = res
        console.log("123")
        console.log(res)
      })
    },
    async getLocationListItemFun() {
      await this.$api.getLocationListItem().then((res) => {
        // this.getLocationListItemData = res.data
      })
    },
  },
  async mounted() {
    ...
    await this.getUnitListItemFun()
    // await this.getLocationListItem()
